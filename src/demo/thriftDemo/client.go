...
func runClient(transportFactory thrift.TTransportFactory, protocolFactory thrift.TProtocolFactory, addr string, secure bool) error {
	...
	err = handleClient(tutorial.NewCalculatorClientFactory(transport, protocolFactory))
	d := time.Since(begin).Nanoseconds() / 1000
	fmt.Println("timeCose us=", d)
	return err
}
